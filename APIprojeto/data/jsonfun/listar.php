<?php
#Este é o arquivo que armazena os dados de listagem de funcionarios.
...
// Agora vamos importar a classe de funcionarios que contém 
...
if($num > 0){
    ...
    while($linha=$stat->fetch(PDO::FETCH_ASSOC)){
        ...
        array_push($funcionario_arr["dados"], $array_item);
    } // Fim do laço while.
